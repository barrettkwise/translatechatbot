...
public class langsel {
    ...
    public langsel (String setlang) {
        ...
        try {
            ...
            File file = new File("F:/school/all programming files/translatechatbot/code/java/lang.txt");
            in = new Scanner(file);

            File file2 = new File("F:/school/all programming files/translatechatbot/code/java/lang2.txt");
