...
public class langsel {
    ...
    public langsel (String setlang) {
        ...
        try {
            ...
            File file = new File("E:/school/all programming files/translatechatbot/text/lang.txt");
            in = new Scanner(file);

            File file2 = new File("E:/school/all programming files/translatechatbot/text/lang2.txt");
